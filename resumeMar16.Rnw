...
\begin{figure}
\vspace{-1ex}
\subsection*{\hspace{-0.7ex} Alberto Sanchez Rodelgo}
\vspace{-2ex}
...
\vspace{+2ex}
\includegraphics[width=0.95\textwidth]{/Users/asanchez3/Desktop/Testing/PresentationOfInformation/photoGSIMzoom.jpg}
{\small
...
\multicolumn{2}{c}{} \\
%\midrule
\textbf{Statistician} & I have always been fascinated by numbers, classifications, data. I ended up studying Maths and specialized in Statistics. Early in my career I worked for the National Statistics Institute of Spain (INE) then in 2012 for the Statistics Department at the IMF. Since November 2015 as a Data Scientist at the World Bank. I accumulate 15 years of experience working in Statistics.\\[3pt]
\textbf{Innovative in data visualization} & I constantly search for innovative ways of presenting data. I have broad experience in Web content design, presentations, \href{https://tcdata360.worldbank.org/reports}{data reports}, infographics, D3 charts and newsletters.\\[3pt]
\textbf{Data Scientist} & In my first job for a financial startup, I modeled intraday stocks market trading. At INE, I used SAS to optimize resource allocation for Data Collection Surveys. I was the analytics expert and R guru in the IMF's Statistics Department. In the Bank I build models, collaborate and present data driven by business questions. I deployed the first ever shiny-server and Connect to help the R research community in the Bank. For example: \href{https://blogs.worldbank.org/opendata/things-do-trade-and-competitiveness-data-thank-you-api}{TCdatascoper} \\[3pt]
& I keep abreast of the developments in Data Science and Machine Learning and I participate in machine learning competitions and sports analytics conferences (MIT Sloan). I have a vast experience with statistical standards (SDMX, GSBPM, GSIM), and contributed papers on the Generic Statistical Business Model (GSIM) \\[3pt]
\textbf{Skilled programmer} & I am an expert in R but also have programmed in Java: \href{http://www.ine.es/geotempus/?L=1}{Geo Statistics}, C++, Python, Visual basic, SAS and SQL. I have broad experience with Microsoft Business Analysis tools.\\[3pt]
\textbf{Database and Web designer} & Extensive experience with relational databases. My major accomplishment was leading the creation of INE's new Dissemination Database, along with its API and powerful Web Applications. Examples of my work: \href{http://www.ine.es/FichasWeb/Welcome.do?L=1}{Geo Statistics}, \href{http://www.ine.es/ss/Satellite?L=es_ES&c=INEmasNoticia_C&cid=1259943920296&idp=1254736092090&pagename=masINE\%2FmasLayout}{Web Magazine}. In the Bank, my main project has been \href{https://tcdata360.worldbank.org/}{TCdata360} \\[3pt]
\textbf{Project Manager} & I managed a team of 12 staff at INE for 3 years and I am currently the data lead in my unit in the Bank. As a project manager I combine expertise, drive for results, and I keep my team highly motivated and well trained. My teams thrive under stretch assignments and tight budgets. As an example: \href{http://www.ine.es/en}{INE's Website}.\\
\end{tabular}
}
\end{minipage}
...
Co-wrote 2 papers for the IMF on the Generic Statistical Information Model (GSIM) \\ and a paper for the MIT sports analytics conference \\[8pt]
\textbf{Education}\\[4pt]
...
\newline \newline
I develop shiny and dashboards to support data analysis, fully fleshed sites or just prototypes, which allows users to interact and download country data and operations reports along with country comparisons and data analysis.
\newline \newline
...
& I managed the Data Warehouse, lead communication and data visualization projects and collaborated in research papers. Evangelist of Data Science and member of the IMF's Big Data competition committee. Organized the Big Data talk by UN Global Pulse director as part of the IMF's 2nd Statistical Forum.
\newline \newline
